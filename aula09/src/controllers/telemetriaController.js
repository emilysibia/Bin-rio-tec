...
const telemetriaController = {
  ...
  // Suporta filtro por Query Parameter: ?alerta=true retorna apenas
  // leituras com temperatura_motor acima de 95 graus
  ...
  // Buscar leituras de telemetria de um veículo específico
